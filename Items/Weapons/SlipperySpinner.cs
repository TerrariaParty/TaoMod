...
{
    public class SlipperySpinner : ModItem
    {
		public override void SetStaticDefaults()
		{
			Tooltip.SetDefault("Throws out a slippery yoyo that coats your enemies in slime\nThey probably are more flamable now");
		...
		public override void SetDefaults()
		{
			...
			item.shoot = ProjectileType<GelYoyo>();
		}
		...
		public override void AddRecipes()
		{
			...
			recipe.AddIngredient(ItemType<SlimeCore>(), 3);

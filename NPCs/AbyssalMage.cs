...
namespace TaoMod.NPCs
{
	...
	{
		public override string Texture => "TaoMod/NPCs/AbyssalMage";
        ...
        public override bool CanTownNPCSpawn(int numTownNPCs, int money) {
            for (int k = 0; k < 255; k++) {
                ...
                if (player.HasItem(ModContent.ItemType<EssenceofYin>()) && Main.hardMode) {
                    return true;
                }
            }
            return false;
		...
		public override void SetChatButtons(ref string button, ref string button2) {
			...
			if (Main.LocalPlayer.HasItem(ItemType<EssenceofYin>()))
		...
		public override void OnChatButtonClicked(bool firstButton, ref bool shop) {
			...
			if (Main.LocalPlayer.HasItem(ItemType<EssenceofYin>()))
				{
					Main.npcChatText = $"What's that you have the- ?! How'd you get your hands on a Essence of Yin? These are incredibly rare! Hm... maybe... Come back to me later. I might have something for you.";
					return;
				}
                shop = true;
			}
		public override void SetupShop(Chest shop, ref int nextSlot) {
			shop.item[nextSlot].SetDefaults(ItemType<EssenceofYin>());
			nextSlot++;
        }
